    ...
    try:
        if status_code == 420:
            ...
            try:
                ...
                q1 = """update control_stream set status = 1 WHERE program_name = 'Streaming_Pre_Prod_2.py' """
                q2 = """update control_stream set status = 2 WHERE program_name = 'Streaming_Pre_Prod_1.py' """
...
TWITTER_CONSUMER_KEY = secret["Consumer_Key_Pre_Prod_1"]
TWITTER_CONSUMER_SECRET = secret["Consumer_Secret_Pre_Prod_1"]
TWITTER_ACCESS_TOKEN = secret["Access_Token_Pre_Prod_1"]
TWITTER_ACCESS_TOKEN_SECRET = secret["Access_Token_Secret_Pre_Prod_1"]
